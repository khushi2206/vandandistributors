...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "min-w-0 font-heading text-base leading-snug font-medium [overflow-wrap:anywhere] group-data-[size=sm]/card:text-sm",
        className
      )}
      {...props}
    />
...
function CardDescription({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("min-w-0 text-sm [overflow-wrap:anywhere] text-muted-foreground", className)}
      {...props}
    />
  )
}
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex min-w-0 flex-wrap items-center rounded-b-xl border-t bg-muted/50 p-(--card-spacing)",
        className
      )}
      {...props}
    />
