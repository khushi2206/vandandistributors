...
const contrastMediaImages = [
  ...
  "/images/contrast-media/lohexol-injection-usp-300mg.jpg",
...
export const contrastProducts: ContrastProduct[] = [
  ...
  },
  {
    ...
    name: "lohexol Injection USP 300mg",
    activeIngredient: "Iohexol",
    category: "x-ray",
    subcategory: "Non-Ionic Contrast Media",
    description:
    ...
    iodineConc: "350 mg/mL",
    packs: ["200 mL vial"],
    image: getContrastMediaImage("contrapaque", "lohexol Injection USP 300mg", "Iohexol"),
