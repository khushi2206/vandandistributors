...
const contrastMediaImages = [
  ...
  "/images/contrast-media/lohexol-injection-usp-300-mg-100-ml.jpg",
  "/images/contrast-media/contrapaque-300mg-50ml.jpg",
  "/images/contrast-media/lohexol-injection-usp-350-mg-100-ml.jpg",
  "/images/contrast-media/lohexol-injection-usp-350-mg-200-ml.jpg",
  "/images/contrast-media/lohexol-injection-usp-350-mg-50-ml.jpg",
...
export const contrastProducts: ContrastProduct[] = [
  {
    id: "lek-pamidol-370",
    name: "Iopamidol Injection USP 370 mg / 100 ml",
    ...
    packs: ["100 mL vial"],
    image: getContrastMediaImage("lek-pamidol", "Iopamidol Injection USP 370 mg / 100 ml", "Iopamidol"),
    specifications: ["Iopamidol 75.5% w/v", "Iodine concentration: 370 mg/mL", "Pack size: 100 mL vial"],
  },
  {
    id: "lohexol-300-100ml",
    name: "lohexol Injection USP 300 mg / 100 ml",
    ...
    packs: ["100 mL vial"],
    image: getContrastMediaImage("lohexol-300-100ml", "lohexol Injection USP 300 mg / 100 ml", "Iohexol"),
    specifications: ["Iohexol 64.7% w/v", "Iodine concentration: 300 mg/mL", "Pack size: 100 mL vial"],
  },
  {
    id: "lohexol-350-50ml",
    name: "lohexol Injection USP 350 mg / 50 ml",
    activeIngredient: "Iohexol",
    category: "x-ray",
    subcategory: "Non-Ionic Contrast Media",
    description:
    ...
    packs: ["50 mL vial"],
    image: getContrastMediaImage("lohexol-350-50ml", "lohexol Injection USP 350 mg / 50 ml", "Iohexol"),
    specifications: ["Iohexol 75.5% w/v", "Iodine concentration: 350 mg/mL", "Pack size: 50 mL vial"],
  },
  {
    id: "lohexol-350-100ml",
    name: "lohexol Injection USP 350 mg / 100 ml",
    activeIngredient: "Iohexol",
    category: "x-ray",
    subcategory: "Non-Ionic Contrast Media",
    description:
    ...
    iodineConc: "350 mg/mL",
    packs: ["100 mL vial"],
    image: getContrastMediaImage("lohexol-350-100ml", "lohexol Injection USP 350 mg / 100 ml", "Iohexol"),
    specifications: ["Iohexol 75.5% w/v", "Iodine concentration: 350 mg/mL", "Pack size: 100 mL vial"],
  },
  {
    id: "lohexol-350-200ml",
    name: "lohexol Injection USP 350 mg / 200 ml",
    activeIngredient: "Iohexol",
    category: "x-ray",
    subcategory: "Non-Ionic Contrast Media",
    description:
    ...
    iodineConc: "350 mg/mL",
    packs: ["200 mL vial"],
    image: getContrastMediaImage("lohexol-350-200ml", "lohexol Injection USP 350 mg / 200 ml", "Iohexol"),
  ...
  {
    id: "trazograf-76",
    name: "Diatrizoate Meglumine & Diatrizoate Sodium Injection USP 76%",
    ...
    image: getContrastMediaImage("trazograf-76", "Diatrizoate Meglumine & Diatrizoate Sodium Injection USP 76%", "Meglumine & Sodium Diatrizoate"),
  },
  {
    id: "trazograf-60",
    name: "Diatrizoate Meglumine Injection USP 60%",
    ...
    packs: ["20 mL amp", "50 mL vial", "100 mL vial"],
    image: getContrastMediaImage("trazograf-60", "Diatrizoate Meglumine Injection USP 60%", "Meglumine Diatrizoate"),
  },
  {
    id: "cardiolek",
    name: "Iodixanol Injection USP 320 mg/mL",
    ...
    image: getContrastMediaImage("cardiolek", "Iodixanol Injection USP 320 mg/mL", "Iodixanol"),
  },
  {
    id: "gastrolek",
    name: "Diatrizoate Sodium Oral Solution USP",
    ...
    image: getContrastMediaImage("gastrolek", "Diatrizoate Sodium Oral Solution USP", "Sodium Diatrizoate"),
  },
  {
    id: "trazogastro",
    name: "Diatrizoate Meglumine & Diatrizoate Sodium Oral Solution USP",
    activeIngredient: "Meglumine & Sodium Diatrizoate",
    category: "oral",
    subcategory: "Oral Contrast Media",
    description:
    ...
    iodineConc: "370 mg/mL",
    packs: ["30 mL bottle", "100 mL bottle"],
    image: getContrastMediaImage("trazogastro", "Diatrizoate Meglumine & Diatrizoate Sodium Oral Solution USP", "Meglumine & Sodium Diatrizoate"),
  },
  {
    id: "magnilek",
    ...
    image: getContrastMediaImage("magnilek", "Gadopentetate Dimeglumine Injection USP", "Gadopentetate Dimeglumine"),
  },
  {
    id: "gadotrast",
...
export const contrastSpecsTable = [
  { product: "Iopamidol Injection USP", ingredient: "Iopamidol 61.2% w/v", iodine: "300 mg/mL", pack: "20 mL amp, 50 mL vial, 100 mL vial" },
  { product: "Iopamidol Injection USP", ingredient: "Iopamidol 69.4% w/v", iodine: "340 mg/mL", pack: "50 mL vial, 100 mL vial" },
  { product: "Iopamidol Injection USP", ingredient: "Iopamidol 75.5% w/v", iodine: "370 mg/mL", pack: "20 mL amp, 50 mL vial, 100 mL vial" },
  { product: "lohexol Injection USP", ingredient: "Iohexol 64.7% w/v", iodine: "300 mg/mL", pack: "20 mL amp, 50 mL vial, 100 mL vial, 200 mL vial" },
  { product: "lohexol Injection USP", ingredient: "Iohexol 75.5% w/v", iodine: "350 mg/mL", pack: "20 mL amp, 50 mL vial, 100 mL vial, 200 mL vial" },
  { product: "Diatrizoate Meglumine & Diatrizoate Sodium Injection USP 76%", ingredient: "Meglumine & Sodium Diatrizoate", iodine: "370 mg/mL", pack: "20 mL amp, 50 mL vial, 100 mL vial" },
  ...
  { product: "Iodixanol Injection USP", ingredient: "Iodixanol", iodine: "320 mg/mL", pack: "50 mL vial, 100 mL vial" },
