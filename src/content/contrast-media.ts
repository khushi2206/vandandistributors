...
export const contrastProducts: ContrastProduct[] = [
  {
    id: "lek-pamidol-370",
    name: "Lek-Pamidol 370 mg / 100 ml",
    ...
    packs: ["100 mL vial"],
    image: getContrastMediaImage("lek-pamidol", "Lek-Pamidol 370 mg / 100 ml", "Iopamidol"),
  ...
  {
    id: "trazograf-76",
    name: "Trazograf 76% Injection 100ml",
    ...
    image: getContrastMediaImage("trazograf-76", "Trazograf 76% Injection 100ml", "Meglumine & Sodium Diatrizoate"),
  },
  {
    id: "trazograf-60",
...
export const contrastSpecsTable = [
  ...
  { product: "Trazograf 76% Injection 100ml", ingredient: "Meglumine & Sodium Diatrizoate", iodine: "370 mg/mL", pack: "20 mL amp, 50 mL vial, 100 mL vial" },
